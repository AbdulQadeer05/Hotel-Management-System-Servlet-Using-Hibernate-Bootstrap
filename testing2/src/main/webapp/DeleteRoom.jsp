...
<nav class="navbar navbar-expand-lg navbar-dark bg-danger">
  ...
  <form action="DeleteRoom" method="post" class="abc">
    <div class="mb-3">
      <label for="exampleInputEmail1" class="form-label text-light">Enter the Name which you want to Delete Room Record </label>
