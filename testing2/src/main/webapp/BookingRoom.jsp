...
<nav class="navbar navbar-expand-lg navbar-dark bg-danger">
  ...
  <form action="RoomBooking" method="post" class="abc">
    <div class="mb-3">
      <label for="exampleInputEmail1" class="form-label text-light">Room Id </label>
      <input type="Number" name="roomId" class="form-control" aria-describedby="emailHelp" placeholder="Enter the Room Id">
      
    </div>
    <div class="mb-3">
      <label for="exampleInputPassword1" class="form-label text-light">User Id</label>
      <input type="Number" name="userId" class="form-control" placeholder="Enter the User Id" >
    </div>
